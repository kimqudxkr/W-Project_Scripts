...
public class center_collider : MonoBehaviour
{
    void OnCollisionEnter(Collision col)
    {
        ...
        if (col.gameObject.tag == "Bullet")
        {
            ...
            gameObject.GetComponent<CenterAlienScript>().ChangeHP(col.gameObject.GetComponent<ProjectileScript>().Damage, col.contacts[0].point);
