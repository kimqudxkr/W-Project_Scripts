...
public class chapter22_bossmonster_collider : MonoBehaviour
{
    void OnCollisionEnter(Collision col)
    {
        ...
        if (col.gameObject.tag == "Bullet")
        {
            ...
            gameObject.GetComponent<chapter22_bossctrl>().ChangeHP(col.gameObject.GetComponent<ProjectileScript>().Damage, col.contacts[0].point);
