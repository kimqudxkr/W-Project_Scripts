...
public class boss_monster_collider : MonoBehaviour
{
    void OnCollisionEnter(Collision col)
    {
        ...
        if (col.gameObject.tag == "Bullet")
        {
            ...
            gameObject.GetComponent<BossCtrl>().ChangeHP(col.gameObject.GetComponent<ProjectileScript>().Damage, col.contacts[0].point);
